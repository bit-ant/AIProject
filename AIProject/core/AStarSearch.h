#ifndef CORE_ASTARSEARCH_H
#define CORE_ASTARSEARCH_H
...
class AStarSearch : public api::ISearchAlgorithm
{
public:
    AStarSearch(const std::shared_ptr<api::EightPuzzleNode> initialState,
